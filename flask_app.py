...
def brief():
    ...
    for sta in stations:
        if sta not in metars:
            metars[sta] = {}
            metars[sta]['raw_text'] = "The station " + sta + " is currently unavailable.  Waiting on NWS data - try refreshing."
        if sta not in tafs:
            tafs[sta] = {}
            tafs[sta]['raw_text'] = "The station " + sta + " is currently unavailable.  Waiting on NWS data - try refreshing."
